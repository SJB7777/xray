...
- **7. ABOUT (제작자 포트폴리오 & 후원):** Isaac Yong (용이삭) 프로필 (서강대 물리학과 학사 졸 / 석사 재학, CUPT 연구실), 연구 도메인(X선 광학, BCDI, DAQ, 실험자동화), GitHub 링크(`SJB7777`), 이메일(`isaacyong@naver.com`), 커피 한 잔 후원 유도
