...
(function (window) {
  ...
  var translations = {
    ko: {
      // Navigation & Sidebar
      nav_dashboard: "0. DASHBOARD (목차)",
      nav_optics: "I. OPTICS (8 Tools)",
      nav_beamline: "II. BEAMLINE (7 Tools)",
      nav_logbook: "III. LOGBOOK",
      nav_experiment: "IV. EXPERIMENT",
      nav_reference: "V. REFERENCE",
      nav_settings: "VI. SETTINGS",
      nav_about: "VII. ABOUT (제작자)",
      ...
      toc_maintitle: "TABLE OF CONTENTS (목차)",
      toc_subtitle: "방사광 X선 광학 계산, 빔라인 물리량 분석, 실험 기록 및 결정학 레퍼런스 종합 색인",
      btn_view_suite: "열기 ➔",
      toc_sec1_title: "X선 광학 및 회절/투과율 정밀 계산기",
      toc_sec1_desc: "파장-에너지 상호 변환, 브래그 법칙, 격자 분산, 복소 굴절률 감쇠 및 상호공간 Q 벡터",
      ...
      toc_sec2_title: "빔라인 물리 및 기하학적 파라미터",
      toc_sec2_desc: "빔 풋프린트, 광자 플럭스, 분해능, 결맞음 CDI/BCDI 샘플링 및 슬릿 지오메트리",
      ...
      toc_sec3_title: "전자 빔라인 로그북 (Electronic Logbook)",
      toc_sec3_desc: "실험 조건 수동 기록, 빠른 태그 검색, 브라우저 저장 및 CSV/JSON 내보내기",
      toc_tool_log_1: "새 실험 로그 작성 (New Log Entry)",
      toc_tool_log_2: "기록된 실험 로그 검색 & 내보내기",
      toc_sec4_title: "실험 종합 관리 (Experiment Suite)",
      toc_sec4_desc: "실시간 자동 저장 실험 노트, 빔라인 체크리스트, 시료 목록, DAQ 산출 및 칸반 보드",
      toc_tool_exp_1: "실시간 자동 저장 실험 노트 (Lab Notes)",
      toc_tool_exp_2: "빔라인 점검 체크리스트 (Checklist)",
      toc_tool_exp_3: "시료 관리 목록 (Sample Inventory)",
      toc_tool_exp_4: "DAQ 데이터 수집 용량 계산기",
      toc_tool_exp_5: "빔타임 작업 칸반 보드 (Kanban)",
      toc_sec5_title: "결정 격자 DB & 연구자 레퍼런스",
      toc_sec5_desc: "단위 변환기, 주요 결정 격자 d-spacing 검색 및 국제 공인 방사광 시설 링크",
      toc_tool_ref_1: "다단위 변환기 (Multi-Unit Converter)",
      toc_tool_ref_2: "결정 격자 d-spacing 데이터베이스",
      toc_tool_ref_3: "공인 국제 방사광 시설 링크",
    ...
    en: {
      // Navigation & Sidebar
      nav_dashboard: "0. DASHBOARD (Index)",
      nav_optics: "I. OPTICS (8 Tools)",
      nav_beamline: "II. BEAMLINE (7 Tools)",
      nav_logbook: "III. LOGBOOK",
      nav_experiment: "IV. EXPERIMENT",
      ...
      // Table of Contents (TOC)
      toc_pretitle: "SYNCHROTRON X-RAY OPTICS & BEAMLINE MONOGRAPH",
      toc_maintitle: "TABLE OF CONTENTS",
      toc_subtitle: "Comprehensive Index of Synchrotron Optics, Beamline Physics & Experimental Suites",
      btn_view_suite: "Open Suite ➔",
      toc_sec1_title: "X-ray Optics & Wave Diffraction Suite",
      toc_sec1_desc: "Wavelength-energy conversions, Bragg diffraction, grating dispersion, complex refraction, and Q-space",
      ...
      toc_sec2_title: "Beamline Physics & Instrumentation",
      toc_sec2_desc: "Beam footprints, delivered photon flux, monochromator bandwidth, coherent oversampling & slit acceptance",
      ...
      toc_sec3_title: "Electronic Experimental Logbook",
      toc_sec3_desc: "Manual condition logging, condition snapshot rollback, tag search, and CSV/JSON/Markdown export",
      toc_tool_log_1: "New Experimental Log Entry",
      toc_tool_log_2: "Logged Records Search & Export",
      toc_sec4_title: "Comprehensive Experiment Suite",
      toc_sec4_desc: "Auto-saving live lab notes, beamline checklist, sample management, DAQ estimator & Kanban board",
      toc_tool_exp_1: "Auto-Saving Live Lab Notes",
      toc_tool_exp_2: "Pre-Beamtime Systems Checklist",
      toc_tool_exp_3: "Sample Inventory & Stage Tracker",
      toc_tool_exp_4: "DAQ Data Rate & Storage Estimator",
      toc_tool_exp_5: "Beamtime Task Kanban Board",
      toc_sec5_title: "Standard Reference & Multi-Converter",
      toc_sec5_desc: "Physical unit converters, crystal d-spacing database, and certified synchrotron facility directories",
      toc_tool_ref_1: "Multi-Unit Scientific Converter",
      toc_tool_ref_2: "Lattice Spacing Crystal Database",
      toc_tool_ref_3: "World Synchrotron Facilities Directory",
      ...
      set_card_history_title: "§ 3. Calculation History Archive",
      ...
      set_card_backup_title: "§ 4. LocalStorage Data Backup & Restore",
      ...
      set_card_shortcuts_title: "§ 5. Keyboard Shortcuts Guide",
