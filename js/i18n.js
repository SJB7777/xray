...
(function (window) {
  ...
  var translations = {
    ko: {
      ...
      dv_c1_title: "§ 1. 데이터 파일 불러오기 (Load Scan Files)",
      dv_c1_tag: "구분자 & 헤더 자동 감지",
      dv_c2_title: "§ 2. XY 플롯 (Generic XY Plot)",
      dv_c2_tag: "Linear / Log · Normalize · Crop",
      dv_c3_title: "§ 3. XRR 세그먼트 이어붙이기 (Segment Stitching)",
      ...
      toc_sec4_title: "스캔 데이터 판독 및 플롯 (Data)",
      toc_sec4_desc: "2열 스캔 파일 자동 판독, XY 플롯과 로그 축, 정규화와 구간 자르기, XRR 세그먼트 이어붙이기",
      toc_tool_dv_1: "데이터 파일 불러오기 (Load Scan Files)",
      toc_tool_dv_2: "XY 플롯 (Generic XY Plot)",
      toc_tool_dv_3: "XRR 세그먼트 이어붙이기 (Stitching)",
