...
(function (window) {
  ...
  var translations = {
    ko: {
      ...
      rec_c1_title: "§ 1. 빔타임 로그북 헤더 프리셋",
      rec_c1_tag: "일반 텍스트 형식",
      rec_c2_title: "§ 2. 실시간 빔타임 이벤트 스니펫",
      ...
      dv_stitch_manual_hint: "§ 1 표의 배율 칸에 직접 값을 입력하면 자동 계산을 덮어쓴다. 칸을 비우면 다시 자동으로 돌아간다. 겹치는 구간이 없는 세그먼트는 배율 1로 두고 표시하므로, 아는 감쇠체 배율을 직접 넣으면 된다.",
      dv_col_file: "파일",
      dv_col_x: "X 열",
      dv_col_y: "Y 열",
      dv_col_range: "X 범위",
      ...
      lat_title: "§ 2. 격자 상수 & 밀러 지수 → 격자면 간격",
      lat_system: "결정계",
      ...
      toc_meta_modules: "모듈:",
      toc_meta_modules_val: "계산기 및 도구 21종",
      ...
      opt_t2_title: "§ 1. 브래그 법칙 3-Way Suite",
      ...
      opt_t5_title: "§ 3. 에너지 스케일링 & 각도 계산기",
      ...
      opt_t6_title: "§ 7. Chi-Phi 오일러 크래들 보정",
      opt_t6_tag: "4축 회절계",
      ...
      opt_t8_title: "§ 2. 상호공간 Q-Space 변환",
      ...
      beam_t7_title: "§ 8. 결정 열팽창 각도 및 에너지 시프트",
    ...
    en: {
      ...
      rec_c1_title: "§ 1. Beamtime Logbook Header Presets",
      rec_c1_tag: "Plain Text Format",
      rec_c2_title: "§ 2. In-Situ Beamtime Event Snippets",
      ...
      dv_c1_title: "§ 1. Load Scan Files",
      dv_c1_tag: "Delimiter & header auto-detect",
      dv_c2_title: "§ 2. Generic XY Plot",
      dv_c2_tag: "Linear / Log · Normalize · Crop",
      dv_c3_title: "§ 3. XRR Segment Stitching",
      ...
      dv_stitch_manual_hint: "Typing a value into the scale column in § 1 overrides the automatic one; clearing the box hands it back to auto. A segment with no overlap is left at scale 1 and flagged, so a known absorber factor can be entered directly.",
      dv_col_file: "File",
      dv_col_x: "X column",
      dv_col_y: "Y column",
      ...
      toc_meta_modules_val: "21 Calculators & Tools",
